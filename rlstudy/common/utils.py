...
import gym
import scipy.signal
from rlstudy.bench.monitor import Monitor
from rlstudy.common import logger
from rlstudy.common.atari_wrappers import make_atari, wrap_deepmind
from rlstudy.common.vec_env.subproc_vec_env import SubprocVecEnv
...
def make_atari_env(env_id, num_env, seed, wrapper_kwargs=None, start_index=0):
    ...
    def make_env(rank): # pylint: disable=C0111
        def _thunk():
            ...
            return wrap_deepmind(env, **wrapper_kwargs) # no wrap frame! just one frame
        return _thunk
